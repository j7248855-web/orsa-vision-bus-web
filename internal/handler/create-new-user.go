...
func CreateNewUser(ctx *gin.Context, conn *sqlx.DB) {
	...
	_, err := conn.Exec("INSERT INTO users (username, password, full_name, permissions, created_at) VALUES ($1, $2, $3, $4, $5)", users.Login, hashedPassword, users.FullName, users.Permissions, time.Now())
	if err != nil {
